...
public class PageMaker {
	...
	// ※ 주의 필드명이 sPageNo 처럼 두번째 알파벳이 대문자인 경우
	//    => setter, getter 는 setSPageNo, setsPageNo , setSpageNo 형태로 만들어질수 있기 때문에
	...
	// => bCheckList 또는 bPageList 등 요청명에 해당하는 url 을 만들수 있도록 하기위함
	...
	public void calcData() {
		...
		// => 요청받은 currPage 11 인경우 epageNo -> (int)Math.ceil(11/3) * 3 = 12
