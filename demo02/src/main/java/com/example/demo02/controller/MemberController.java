...
import com.example.demo02.service.JoService;
import com.example.demo02.service.MemberService;
...
public class MemberController {
	...
	public String mjoin(Model model ,HttpServletRequest request , MemberDTO dto) throws IOException {
		...
		if(!file.exists()) {
			String basicImagePath ="C:\\MTest\\myWork\\demo02\\src\\main\\webapp\\resources\\images\\basicman4.png";
