...
public class Ex06_mkDir {
	...
	public static void main(String[] args) {
		...
		// ** mkDir
		File f2 = new File("c:\\MTest\\MyWork\\ppp") ; // 새로만들려는 디렉토리
		...
		listDirectory(new File("c:\\MTest\\MyWork"));    // c:\\MTest\\MyWork 의 목록 출력
		f2.renameTo(new File("c:\\MTest\\MyWork\\aaa")); // ppp -> aaa 로 이름 변경
		listDirectory(new File("c:\\MTest\\MyWork"));    // aaa 로 변경한 후 리스트 출력
	} //main
} //class
