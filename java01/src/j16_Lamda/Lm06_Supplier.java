...
public class Lm06_Supplier {
	...
	public static void main(String[] args) {
        ...
        // Supplier의 get() 메서드를 호출하여 값을 얻음
        Integer randomValue = sp.get();
        ...
        // Supplier를 사용하여 문자열을 반환하는 예제
        Supplier<String> stringSupplier = () -> "Hello, Java!";
        
        // Supplier의 get() 메서드를 호출하여 값을 얻음
        System.out.println(stringSupplier.get());
        
     // Supplier를 사용하여 현재 시간을 반환하는 예제
        Supplier<Long> currentTimeSupplier = () -> System.currentTimeMillis();
        
        // Supplier의 get() 메서드를 호출하여 현재 시간을 얻음
        System.out.println("Current time in milliseconds: " + currentTimeSupplier.get());
