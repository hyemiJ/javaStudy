...
<body>
	...
	<h2 id="review">리뷰 쓰기가 가능한지 표시되는 곳 입니다.</h2>
	...
	let fx = options.center.getLat(); //처음 받은 음식점의 위도
	let fy = options.center.getLng(); //처음 받은 음식점의 경도
	console.log(fx,fy);
//--------------------------------------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------------------------------------		
	// 음시점 마커 생성
	// 마커가 표시될 위치입니다 
	let markerPosition  = map.getCenter(); 
	...
	let iwContent = '<div style="padding:5px;">음식점 <br><a href="https://map.kakao.com/link/map/Hello World!,33.450701,126.570667" style="color:blue" target="_blank">큰지도보기</a> <a href="https://map.kakao.com/link/to/Hello World!,33.450701,126.570667" style="color:blue" target="_blank">길찾기</a></div>', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
	...
	//현재 내 위치 좌표입니다.
	let ux = locPosition.getLat(); //내 위치 위도
	let uy = locPosition.getLng(); //내 위치 경도
	console.log(ux,uy);
