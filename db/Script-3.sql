...
-- lastproject.packagingoptions definition
...
-- lastproject.products definition
...
-- lastproject.addresses definition
...
-- lastproject.producthistory definition
...
CREATE TABLE `producthistory` (
  ...
  CONSTRAINT `producthistory_addresses_FK` FOREIGN KEY (`address_id`) REFERENCES `addresses` (`address_id`),
  CONSTRAINT `producthistory_customer_FK` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`)
) ;


-- lastproject.productimages definition
...
-- lastproject.productoptions definition
...
-- lastproject.purchaselist definition
...
-- lastproject.registedhistory definition
...
-- lastproject.registdatecnt definition
