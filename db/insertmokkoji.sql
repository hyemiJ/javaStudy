...
ALTER TABLE project.orders DROP FOREIGN KEY orders_addresses_FK;

ALTER TABLE project.orders CHANGE address_id street_address varchar(255) NOT NULL COMMENT '배송지 아이디';
ALTER TABLE project.orders MODIFY COLUMN street_address varchar(255) NOT NULL COMMENT '배송지 아이디';

ALTER TABLE project.orders DROP INDEX orders_addresses_FK;
