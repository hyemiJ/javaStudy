...
public class HomeController {	
   ...
   // public String redirectToHome() {
    ...
    //public void home(Locale locale, Model model) {
		...
		String name = "홍길동";
		int age = 99;
		//logger.info("Logge Test [info]=> name : {} , age => {}", name , age);
		//logger.warn("Logge Test [warn]=> name : {} , age => {}", name , age);
		//logger.error("Logge Test [error]=> name : {} , age => {}", name , age);
		
		//** Lombok의 @Log4j2
		//log.info("Lombok의 @Log4j2");
		//log.info("Lombok의 Test [info]=> name : "+name+", age => "+age);
		//log.info("Lombok의 Test [info]=> name : "+name+", age => "+age);
		//log.debug("Lombok의 Test [debug]=> 레벨 조정 전에는 출력되지 않아야함.");
		//log.debug("Lombok의 Test [debug]=> name : "+name+", age => "+age);
